...
const AdmCombustibles = () => {
  ...
  const handleDelete = async (idCombustible) => {
    ...
    try {
      ...
      console.log('Combustible eliminado:', data.message);
  ...
  return (
    <ContenedorTabla>
      ...
      <BotonAgregar as={Link} to="/AdmCombustibles/FormCombustible">Nuevo</BotonAgregar>
...
export default AdmCombustibles;
